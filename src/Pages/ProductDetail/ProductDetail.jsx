...
import { BackArrowIcon, HearthIcon, quicelum } from '../../assets/content'
    ...
    return (
        <section className='w-full mt-20'>
            <Grid className='lg:mt-10 mt-2 lg:w-[80%] grid mx-auto grid-cols-6 lg:grid-cols-10 gap-2 lg:gap-10'>
                ...
                <div className='lg:col-span-5 col-span-10 lg:ms-14 lg:space-y-5 lg:mt-0 mt-4 lg:p-0 ps-8 pe-8'>
                    ...
                    <Flex className='mt-8 flex justify-between items-center lg:space-y-28'>
