...
import { googleLogo, ArrowUpRight, agrozamLogo } from '../../assets/content'
    ...
    return (
        <>
            <form onSubmit={loginWithEmail} className="flex justify-center flex-col w-[100%] lg:w-[400px] gap-2">
                ...
                <h1 className="text-xl font-bold text-black text-center">Ingresa a agrozam</h1>
